...
const DEFAULTS = {
  ...
  providers: {
    ...
    literature: {
      // Peer-reviewed review-level publications, queried live from PubMed.
      // Replaces the news provider, whose unit was a headline — written to be
      // clicked, and unable to state a finding, a design or an effect size.
      enabled: true,
